    ...
    >
      ...
      <div className="flex-1 overflow-y-auto p-4">
        <div className="bg-gray-900 rounded-lg border border-gray-800 overflow-hidden">
          <div className="px-3 py-2 bg-gray-800/50 border-b border-gray-800 text-xs text-gray-400 flex items-center justify-between">
            ...
            {lines.map((line, i) => {
              ...
              return (
                <motion.div
                  ...
                  animate={
                    shouldHighlight
                      ? { backgroundColor: ['transparent', 'rgba(139, 92, 246, 0.2)', 'rgba(139, 92, 246, 0.1)'] }
                      : {}
                  }
                  transition={{ duration: 1, delay: i * 0.1 }}
                  className={cn(
                    'py-0.5 px-1 -mx-1 rounded',
                    shouldHighlight && 'border-l-2 border-system'
                  )}
                >
                  {line.startsWith('#') ? (
          ...
          {!expanded && (
            <div className="h-12 bg-gradient-to-t from-gray-900 to-transparent -mt-12 relative" />
          )}
        </div>
      </div>
      ...
      <div className="p-4 border-t border-gray-800">
        <div className="text-xs text-gray-500">
          <strong className="text-gray-400">What's this?</strong> A hidden prompt sent with every
