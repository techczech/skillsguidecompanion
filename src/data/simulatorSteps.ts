export interface SimulatorStep {
  id: string
  phase: 'setup' | 'system-prompt' | 'thinking' | 'tool-call-read' | 'file-contents' | 'generate-html' | 'tool-call-execute' | 'terminal' | 'response' | 'reveal'
  title: string
...
export const simulatorSteps: SimulatorStep[] = [
  ...
  },
  {
    ...
    narration: 'Following step 1 of the instructions: "Generate HTML with slide structure"',
    expandable: {
      title: 'Why HTML first?',
      content: "The model generates structured HTML content based on the user's request. This HTML becomes the input for the pre-written script. The model is great at generating content - the script handles the conversion.",
    },
    duration: 4000,
  },
  {
    ...
    title: 'Calling the Script',
    narration: 'Now step 2: "Use html2pptx.js to convert" - the model calls the pre-written script',
    duration: 3000,
  },
  {
    id: 'terminal',
...
export const generatedHtmlContent = `<!-- Generated by Claude following SKILL.md instructions -->
<slides>
  <slide title="The Water Cycle">
    <h1>The Water Cycle</h1>
    <subtitle>Nature's Recycling System</subtitle>
  </slide>

  <slide title="Evaporation">
    <h2>1. Evaporation</h2>
    <ul>
      <li>Sun heats water in oceans, lakes, rivers</li>
      <li>Water transforms from liquid to vapor</li>
      <li>Rises into the atmosphere</li>
    </ul>
  </slide>

  <slide title="Condensation">
    <h2>2. Condensation</h2>
    <ul>
      <li>Water vapor cools as it rises</li>
      <li>Forms tiny droplets around particles</li>
      <li>Creates clouds and fog</li>
    </ul>
  </slide>
...
export const toolCallWrite = {
  name: "write_file",
  arguments: {
    path: "temp/slides.html",
